...
|---|---|---|
| **Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software.** | **Gabriel Cristian Mamani Marca** <br> **TB2:** Actualicé y apliqué conocimientos en arquitectura de software y diseño de soluciones empresariales mediante el desarrollo completo del *Architectural Design Backlog 1* de Finteka, definiendo componentes clave, prioridades técnicas y lineamientos estructurales para la evolución del sistema. <br><br> **TP1:** Actualicé y apliqué conocimientos en desarrollo full stack, integración de tecnologías y buenas prácticas de implementación al participar en el desarrollo del Sprint 1 de Finteka, construyendo funcionalidades iniciales alineadas a los requisitos funcionales y no funcionales previamente establecidos. | **Gabriel Cristian Mamani Marca** <br> **TB2:** La actualización de conocimientos en arquitectura permitió establecer una base técnica más sólida para Finteka, facilitando la organización del sistema y la toma de decisiones tecnológicas futuras. <br><br> **TP1:** La actualización de conocimientos en desarrollo e integración tecnológica permitió materializar la primera versión funcional del sistema, asegurando coherencia entre los requerimientos definidos y la implementación realizada. |
| **Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software.** | **Gabriel Cristian Mamani Marca** <br> **TB2:** Reconocí la importancia del aprendizaje continuo al investigar y aplicar enfoques de arquitectura de software, priorización técnica y diseño escalable durante la elaboración del *Architectural Design Backlog 1* para Finteka. <br><br> **TP1:** Reconocí la necesidad del aprendizaje permanente al aplicar nuevas herramientas, frameworks y metodologías de desarrollo durante la ejecución del Sprint 1, fortaleciendo mis capacidades para construir soluciones funcionales y adaptables. | **Gabriel Cristian Mamani Marca** <br> **TB2:** El aprendizaje permanente permitió mejorar la comprensión de arquitecturas modernas y estructurar soluciones más escalables, mantenibles y alineadas a los objetivos del proyecto. <br><br> **TP1:** El aprendizaje continuo permitió adaptarse a nuevos retos técnicos durante la implementación del Sprint 1, contribuyendo al desarrollo eficiente de una solución de software funcional y preparada para futuras mejoras. |
