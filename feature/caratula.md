...
|---|---|---|
| **Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software.** | **Daiki Oscar Oshiro Yamashita**<br>TB1: Actualicé y apliqué conocimientos de UX y metodologías ágiles durante el desarrollo de Finteka, elaborando el User Task Matrix, Empathy Mapping, As-is Scenario Mapping y revisando el Product Backlog para mejorar la definición del proyecto.<br>TB2: Apliqué el modelo C4 mediante la elaboración de los diagramas de contexto, contenedores y componentes de Finteka, fortaleciendo la comprensión de la arquitectura del sistema.<br>TP1: Corregí los diagramas de contexto, contenedores y componentes del modelo C4 de Finteka, fortaleciendo la comprensión de la arquitectura del sistema durante el desarrollo del proyecto.<br><br>**Anaely Burga Loarte**<br>TB1: Actualicé y apliqué conocimientos de investigación de usuarios mediante la elaboración del análisis de competidores y el desarrollo de Needfinding.<br>TP1: Refiné el análisis de competidores y los User Personas basándome en el feedback recibido, asegurando que los perfiles de usuario representen fielmente las necesidades identificadas para Finteka.<br><br>**Sergio Aguirre Castillo**<br>TB1: Actualicé y apliqué conocimientos en desarrollo de software utilizando lenguajes como Python, C++ y C#, participando en la implementación de funcionalidades.<br>TP1: Revisé y optimicé la implementación inicial de funcionalidades en el proyecto, aplicando patrones de diseño y estándares de codificación para mejorar la mantenibilidad del código.<br><br>**Gabriel Cristian Mamani Marca**<br>TB1: Identifiqué y analicé detalladamente los segmentos objetivo y elaboré los requisitos funcionales y no funcionales de Finteka.<br>TB2: Desarrollé el Architectural Design Backlog 1 de Finteka, fortaleciendo la planificación técnica y estructuración del sistema.<br>TP1: Actualicé y apliqué conocimientos en metodologías ágiles mediante la participación en el Sprint 1 de Finteka, contribuyendo en la organización y seguimiento de actividades.<br><br>**Augusto Sebastian Montes Maza**<br>TB1: Lideré la estructuración del Lean UX Problem Statement y la definición de hipótesis de negocio.<br>TP1: Corregí y validé las hipótesis de negocio y el Lean UX Canvas, integrando ajustes técnicos sobre escalabilidad para asegurar la viabilidad tecnológica de la propuesta. | **Daiki Oscar Oshiro Yamashita**<br>TP1: La corrección de los diagramas C4 permitió estructurar y comprender mejor la arquitectura de Finteka, facilitando la identificación de sus componentes y relaciones.<br><br>**Anaely Burga Loarte**<br>TP1: La actualización y refinamiento de los perfiles de usuario permitió una segmentación más precisa, facilitando el diseño de soluciones enfocadas en problemas reales del mercado.<br><br>**Sergio Aguirre Castillo**<br>TP1: La revisión técnica y optimización del código garantizó una base más sólida para el crecimiento del software, reduciendo la deuda técnica desde las etapas iniciales.<br><br>**Gabriel Cristian Mamani Marca**<br>TP1: La participación en el Sprint 1 permitió consolidar conocimientos en metodologías ágiles y trabajo colaborativo, contribuyendo al avance ordenado de las funcionalidades.<br><br>**Augusto Sebastian Montes Maza**<br>TP1: El refinamiento de las hipótesis de negocio permitió alinear los objetivos técnicos con las necesidades reales del mercado, garantizando una base sólida para el desarrollo. |
| **Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software.** | **Daiki Oscar Oshiro Yamashita**<br>TB1: Investigué nuevas técnicas de análisis de usuarios y gestión ágil aplicándolas en Finteka.<br>TB2: Apliqué el modelo C4 en Finteka mediante sus diagramas de contexto, contenedores y componentes.<br>TP1: Reconocí la importancia del aprendizaje permanente al corregir los diagramas de contexto, contenedores y componentes del modelo C4 en Finteka.<br><br>**Anaely Burga Loarte**<br>TB1: Apliqué técnicas de Needfinding y construcción de User Personas investigando nuevos enfoques centrados en el usuario.<br>TP1: Reconocí la necesidad de aprendizaje continuo al profundizar en métodos de validación de usuarios para mejorar la precisión de los artefactos de UX de Finteka.<br><br>**Sergio Aguirre Castillo**<br>TB1: Investigué tecnologías, frameworks y buenas prácticas de programación para mejorar el desempeño en el proyecto.<br>TP1: Reconocí la importancia del aprendizaje constante al investigar estándares de refactorización y calidad de software aplicados a los lenguajes utilizados en Finteka.<br><br>**Gabriel Cristian Mamani Marca**<br>TB1: Investigué enfoques para la identificación de segmentos y elaboración de requisitos.<br>TB2: Aplicó conceptos de arquitectura de software para la elaboración del Architectural Design Backlog 1.<br>TP1: Reconocí la necesidad del aprendizaje permanente al participar en el Sprint 1 de Finteka, adaptándome a dinámicas de trabajo ágil y herramientas colaborativas.<br><br>**Augusto Sebastian Montes Maza**<br>TB1: Investigué sobre pasarelas de pago y escalabilidad en la nube para fortalecer la seguridad en FinTeka.<br>TP1: Reconocí la importancia del aprendizaje continuo al investigar nuevas normativas de cumplimiento legal para plataformas de consultoría, integrándolas en la propuesta del proyecto. | **Daiki Oscar Oshiro Yamashita**<br>TP1: La corrección de los diagramas del modelo C4 reforzó la necesidad de aprendizaje continuo para comprender mejor la arquitectura del sistema.<br><br>**Anaely Burga Loarte**<br>TP1: El aprendizaje permanente asegura que el diseño del software evolucione con las necesidades del usuario, evitando suposiciones incorrectas en la etapa de definición.<br><br>**Sergio Aguirre Castillo**<br>TP1: El aprendizaje continuo en buenas prácticas de programación es vital para producir software de alta calidad que sea fácil de mantener y escalar.<br><br>**Gabriel Cristian Mamani Marca**<br>TP1: La participación constante en procesos ágiles reforzó la importancia de seguir aprendiendo nuevas herramientas para mejorar la productividad del equipo.<br><br>**Augusto Sebastian Montes Maza**<br>TP1: El aprendizaje constante sobre seguridad y regulaciones tecnológicas permite que la solución propuesta sea competitiva, legalmente viable y confiable para el usuario. |
