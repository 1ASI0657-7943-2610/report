...
|---|---|---|
| **Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software.** | **Daiki Oscar Oshiro Yamashita**<br>TB1: Actualicé y apliqué conocimientos de UX y metodologías ágiles durante el desarrollo de Finteka, elaborando el User Task Matrix, Empathy Mapping, As-is Scenario Mapping y revisando el Product Backlog.<br>TB2: Apliqué el modelo C4 mediante la elaboración de los diagramas de contexto, contenedores y componentes de Finteka.<br>TP1: Corregí los diagramas de contexto, contenedores y componentes del modelo C4 de Finteka, fortaleciendo la comprensión de la arquitectura del sistema.<br><br>**Anaely Burga Loarte**<br>TB1: Actualicé y apliqué conocimientos de investigación de usuarios mediante la elaboración del análisis de competidores y el desarrollo de Needfinding. Diseñé User Personas basadas en datos recolectados.<br>TP1: Corregí y refiné el análisis de competidores y los User Personas de Finteka, fortaleciendo la segmentación de usuarios durante el desarrollo del proyecto.<br><br>**Sergio Aguirre Castillo**<br>TB1: Actualicé y apliqué conocimientos en desarrollo de software utilizando lenguajes como Python, C++ y C#, participando en la implementación de funcionalidades de Finteka.<br>TP1: Corregí y optimicé módulos de código iniciales en Python y C# para Finteka, fortaleciendo la calidad de la implementación técnica durante el desarrollo del proyecto.<br><br>**Gabriel Cristian Mamani Marca**<br>TB1: Identifiqué y analicé segmentos objetivo y elaboré los requisitos funcionales y no funcionales de la aplicación Finteka.<br>TB2: Desarrollé el Architectural Design Backlog 1 de Finteka, fortaleciendo la planificación técnica y estructuración del sistema.<br>TP1: Actualicé y apliqué conocimientos en metodologías ágiles mediante la participación en el Sprint 1 de Finteka, contribuyendo en la ejecución y seguimiento de actividades.<br><br>**Augusto Sebastian Montes Maza**<br>TB1: Lideré la estructuración del Lean UX Problem Statement y la definición de hipótesis de negocio para FinTeka. Refoncé capacidades en análisis de requerimientos técnicos.<br>TP1: Corregí el Lean UX Problem Statement y las hipótesis de negocio de Finteka, fortaleciendo la viabilidad del modelo de solución durante el desarrollo del proyecto. | **Daiki Oscar Oshiro Yamashita**<br>TB1: La actualización constante permitió mejorar el análisis y planificación del proyecto.<br>TB2: La elaboración de diagramas C4 permitió estructurar mejor la arquitectura.<br>TP1: La corrección de los diagramas C4 permitió estructurar y comprender mejor la arquitectura de Finteka.<br><br>**Anaely Burga Loarte**<br>TB1: La actualización en investigación permitió comprender mejor el entorno competitivo y las necesidades reales.<br>TP1: La corrección de los artefactos de UX permitió definir con mayor precisión el mercado objetivo y la propuesta de valor.<br><br>**Sergio Aguirre Castillo**<br>TB1: La actualización técnica permitió mejorar la calidad del desarrollo y optimizar funcionalidades.<br>TP1: La revisión del código permitió mejorar la eficiencia y robustez de las funcionalidades implementadas en el proyecto.<br><br>**Gabriel Cristian Mamani Marca**<br>TB1: Permitió estructurar de manera clara las necesidades del sistema, alineando requerimientos y funcionalidades.<br>TB2: Fortaleció la organización técnica, facilitando la priorización de actividades de arquitectura.<br>TP1: La participación en el Sprint 1 permitió consolidar conocimientos en metodologías ágiles y trabajo colaborativo.<br><br>**Augusto Sebastian Montes Maza**<br>TB1: Permitió alinear los objetivos técnicos con las necesidades del mercado, garantizando una base sólida.<br>TP1: La corrección de los supuestos de negocio permitió asegurar que la arquitectura técnica soporte los objetivos comerciales de la plataforma. |
| **Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software.** | **Daiki Oscar Oshiro Yamashita**<br>TB1: Reconocí la necesidad del aprendizaje continuo al investigar nuevas técnicas de análisis de usuarios y gestión ágil.<br>TB2: Reconocí la importancia del aprendizaje permanente al aplicar el modelo C4 en Finteka.<br>TP1: Reconocí la importancia del aprendizaje permanente al corregir los diagramas de contexto, contenedores y componentes del modelo C4 en Finteka.<br><br>**Anaely Burga Loarte**<br>TB1: Reconocí la importancia del aprendizaje continuo al aplicar técnicas de Needfinding y construcción de User Personas.<br>TP1: Reconocí la importancia del aprendizaje permanente al corregir el análisis de competidores y User Personas en Finteka.<br><br>**Sergio Aguirre Castillo**<br>TB1: Reconocí la importancia del aprendizaje continuo al investigar nuevas tecnologías, frameworks y buenas prácticas de programación.<br>TP1: Reconocí la importancia del aprendizaje permanente al corregir y refactorizar la lógica de programación en el proyecto Finteka.<br><br>**Gabriel Cristian Mamani Marca**<br>TB1: Reconocí la necesidad del aprendizaje continuo al investigar enfoques para la identificación de segmentos y requisitos.<br>TB2: Reconocí la importancia del aprendizaje continuo al investigar conceptos de arquitectura para el Architectural Design Backlog 1.<br>TP1: Reconocí la necesidad del aprendizaje permanente al participar en el Sprint 1 de Finteka, adaptándome a dinámicas de trabajo ágil.<br><br>**Augusto Sebastian Montes Maza**<br>TB1: Reconocí la importancia del aprendizaje permanente al investigar sobre pasarelas de pago seguras y escalabilidad en la nube.<br>TP1: Reconocí la importancia del aprendizaje permanente al corregir los planteamientos de Lean UX y análisis de requerimientos en Finteka. | **Daiki Oscar Oshiro Yamashita**<br>TB1: El aprendizaje es clave para adaptarse a nuevas metodologías eficientes.<br>TB2: El modelo C4 reforzó la necesidad de aprendizaje continuo para la arquitectura.<br>TP1: La corrección de los diagramas del modelo C4 reforzó la necesidad de aprendizaje continuo.<br><br>**Anaely Burga Loarte**<br>TB1: Permite desarrollar soluciones más centradas en el usuario y mejorar la efectividad del diseño.<br>TP1: El refinamiento de la investigación de usuarios reforzó la necesidad de aprendizaje continuo para entender el mercado.<br><br>**Sergio Aguirre Castillo**<br>TB1: Permite mantenerse actualizado para desarrollar soluciones más eficientes y escalables.<br>TP1: La optimización constante de código reforzó la necesidad de aprender mejores prácticas de desarrollo de software.<br><br>**Gabriel Cristian Mamani Marca**<br>TB1: Contribuye al desarrollo de soluciones de software más claras y alineadas a las necesidades del usuario.<br>TB2: Contribuyó a diseñar soluciones más ordenadas, escalables y alineadas al proyecto.<br>TP1: La participación constante en procesos ágiles reforzó la importancia de aprender nuevas herramientas colaborativas.<br><br>**Augusto Sebastian Montes Maza**<br>TB1: Es indispensable para integrar tecnologías emergentes de seguridad y escalabilidad.<br>TP1: El ajuste de la estrategia de negocio y técnica reforzó la necesidad de aprendizaje continuo para garantizar la competitividad. |
